...
df_time.to_csv(dir_path + "/Data/Alternatives/timeline_outcomes.csv", index=False)
...
descriptives_all_years.to_csv(dir_path + "/Data/Alternatives/descriptives_all_years_outcomes.csv", index=False)
