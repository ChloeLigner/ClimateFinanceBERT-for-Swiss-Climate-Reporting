...
df_time.to_csv(dir_path + "/Code/ClimateFinanceBERT/Data/Alternatives/timeline_keyExpectedResults.csv", index=False)
...
descriptives_all_years.to_csv(dir_path + "/Code/ClimateFinanceBERT/Data/Alternatives/descriptives_all_years_keyExpectedResults.csv", index=False)
