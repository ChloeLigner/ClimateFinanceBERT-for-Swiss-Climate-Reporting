...
df_time.to_csv("C:/Users/chloe/Desktop/Master Thesis/Code/ClimateFinanceBERT/Data/timeline_withoutcorecontribution.csv", index=False)
...
descriptives_all_years.to_csv(dir_path + "/Data/descriptives_all_years_withoutcorecontribution.csv", index=False)
