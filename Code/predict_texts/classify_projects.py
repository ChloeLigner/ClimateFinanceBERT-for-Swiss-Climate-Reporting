...
""" This file imports the ClimateFinanceBERT classifiers to predict climate relevance and categories for the sdc dataset"""
...
for chunk in csv_import(dir_path + "/Data/df_preprocessed.csv"):
    ...
    with torch.no_grad():
        ...
        text_seq, text_mask = tokenize(chunk['text'].tolist())
    ...
    print(chunk[['text', 'climate_relevance']])
    ...
    valid_texts = relevant_texts['text'].dropna().tolist()  # Remove None values
    ...
    print(chunk[['text', 'climate_relevance', 'climate_class']])
